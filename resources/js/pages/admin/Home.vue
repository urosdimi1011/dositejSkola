<template>
    <admin-layout>
        ...
        <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mt-5" @click="addNewRooms()">Dodaj novo obaveštenje</button>
...
const getAllData = async ()=>{
    const response = await axios.get('/obavestenja');
    dataForBody.value = response.data.obavestenja;
}
...
const addNewRooms = ()=>{
    ...
    dialog.dialogTitle = "Dodaj novu objavu";
    dialog.dialogComponent = NoticeForm;
}
</script>
<style scoped>
