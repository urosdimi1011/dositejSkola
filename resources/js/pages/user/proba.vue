                        ...
                        <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                            ...
                            <li>
                                ...
                                <div id="dropdown" class="z-1000 hidden bg-white divide-y divide-gray-100 rounded-lg shadow-sm w-44 dark:bg-gray-700">
                                    <ul class="py-2 text-sm text-gray-700 dark:text-gray-700" aria-labelledby="dropdownDefaultButton">
                                        ...
                                        <li>
                                            <a href="#" data-dropdown-toggle="doubleDropdown" data-dropdown-placement="right-start" class="group font-bold flex items-center gap-2 px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Особље <PhArrowRight :size="12" /></a>
                                        ...
                                        <li>
                                            <Link :class="[isActive('/vazni-dokumenti') ? 'text-red-800' : 'text-gray-900']" href="/vazni-dokumenti" class="font-bold block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Важни документи</Link>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                            ...
                            <li>
                                ...
                                <div id="dropdownHover2" class="z-100 hidden bg-white divide-y divide-gray-100 rounded-lg shadow-sm w-44 dark:bg-gray-700">
                                    <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownHoverButton">
                                        <li>
                                            <Link :class="[isActive('/raspored/exam') ? 'text-red-800' : 'text-gray-900']" href="/raspored/exam" class="font-bold block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Распоред испита</Link>
                                        </li>
                                        <li>
                                            <Link :class="[isActive('/raspored/class') ? 'text-red-800' : 'text-gray-900']" href="/raspored/class" class="font-bold block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Распоред наставе</Link>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                            ...
                            <li>
                                <Link href="#" data-dropdown-trigger="hover" data-dropdown-toggle="dropdownHover4" class="font-bold block py-2 pr-4 pl-3 text-gray-900 border-b border-gray-100 hover:bg-gray-50 hover:text-amber-500 lg:hover:bg-transparent lg:border-0 lg:p-0">Студентски инфо сервис</Link>
                                <div id="dropdownHover4" class="z-100 hidden bg-white divide-y divide-gray-100 rounded-lg shadow-sm w-44 dark:bg-gray-700">
                                    <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownHoverButton">
                                        ...
                                        <li>
                                            <Link :class="[isActive('/upustvo-za-studente') ? 'text-red-800' : 'text-gray-900']"  href="/upustvo-za-studente" data-dropdown-trigger="hover"  data-dropdown-toggle="doubleDropdown3" data-dropdown-placement="right-start" class="font-bold block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Обрасци</Link>
                                            <div id="doubleDropdown3"  class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow-sm w-44 dark:bg-gray-700">
                                                <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="doubleDropdownButton">
                                                    <li>
                                                        <a href="/assets/files/Obrazac-za-prijavu-zavrsnog-rada-I-stepena.doc" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Пријава завршног рада</a>
                                                    </li>
                                                    <li>
                                                        <a href="/assets/files/Obrazac-za-prijavu-zavrsnog-rada-na-master-studijama.doc" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Пријава мастер рада</a>
                                                    </li>
                                                    <li>
                                                        <a href="/assets/files/Упутство-за-израду-завршног-рада.doc" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Упуство за израду дипломског рада</a>
                                                    </li>
                                                    <li>
                                        ...
                                        <li>
                                            <Link :class="[isActive('/raspored-nastave') ? 'text-red-800' : 'text-gray-900']" href="/raspored-nastave" class="font-bold block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Распореди и календари</Link>
                                        </li>
                                        <li>
