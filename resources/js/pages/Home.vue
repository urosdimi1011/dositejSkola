...
const getAllNotices = async ()=>{
    ...
    notices.value = response.data.obavestenja;
    spinner.value = false;
}

onMounted(async ()=>{
    initFlowbite();
    dodajEfekteNaTekstUSlajderu();
    await getAllNotices();

})
const dodajEfekteNaTekstUSlajderu = ()=>{
    const items = document.querySelectorAll('[data-carousel-item]');

    const observer = new MutationObserver(() => {
        items.forEach((item) => {
            const classList = item.classList;
            const content = item.querySelector(".carousel-text-content");
            const align = item.getAttribute("data-align");

            if (!content) return;

            const isVisible = classList.contains("z-30");
            ...
            if (isVisible) {
                ...
                if (align === "left") {
                    content.classList.add("items-start",
                        "!translate-x-[5%]",
                        "sm:!translate-x-[10%]",
                        "md:!translate-x-[15%]",
                        "lg:!translate-x-[50%]",
                ...
                content.classList.remove("opacity-100", "-translate-x-full",
                    "!translate-x-[5%]",
                    "sm:!translate-x-[10%]",
                    "md:!translate-x-[15%]",
                    "lg:!translate-x-[20%]",
    ...
    <my-layout>
        <div id="default-carousel" class="relative  w-full" data-carousel="slide">
            ...
            <div class="relative z-20 h-56 overflow-hidden rounded-lg md:h-96">
                <!-- Slide 1 -->
                <div class="hidden duration-700 ease-in-out z-20" data-carousel-item data-align="left">
                    <img
                    ...
                    <div class="absolute inset-0">
                        <div class="flex h-full flex-col justify-center text-white text-center p-6 rounded bg-black/30 opacity-0 transition-all duration-1000 ease-in-out"
                             data-carousel-item-visible="true">
                            <div class="carousel-text-content !w-[90%] sm:!w-[80%] md:!w-[60%] lg:!w-[50%] xl:!w-[50%] translate-x-[50%] text-left transition-all duration-1500 ease-in-out">
                                <h2 class="hover:text-red-800  !text-lg md:!text-4xl font-bold text-shadow-lg">Знање које покреће каријеру!</h2>
                ...
                <!-- Slide 2 -->
                <div class="hidden duration-700 ease-in-out z-20" data-carousel-item data-align="right">
                    <img
                    ...
                    />
                    <div class="absolute inset-0">
                        <div class=" flex h-full flex-col justify-center text-white text-center p-6 rounded bg-black/30 opacity-0 "
                             data-carousel-item-visible="true">
                            <div class="carousel-text-content !w-[90%] sm:!w-[80%] md:!w-[60%] lg:!w-[50%] xl:!w-[60%] transition-all duration-1500 ease-in-out">
                                <h2 class="!text-lg md:!text-4xl font-bold text-shadow-lg">Будите корак испред - Доситеј академија,<br/> место где знање и технологија обликују будућност!</h2>
                                <Link href="/prijava"><button type="submit" class="cursor-pointer mt-3 inline-block text-red-700 border border-orange-400 px-3 py-1 text-sm rounded hover:bg-orange-50 transition">Пријави се</button></Link>
                            </div>
                        </div>
                    </div>
        ...
        <div class="notification-block mx-auto max-w-screen-xl">
            <div class="header-block my-10">
                <h2 class="!text-xl sm:!text-3xl text-gray-950 font-medium">Обавештења
                    <span class="underline w-1/12 bg-red-800 h-1 block rounded-sm"></span>
                </h2>
                <div class="all-notices">
                    <Link class="mt-3 inline-block text-red-700 border border-orange-400 px-3 py-1 !text-xs sm:!text-sm rounded hover:bg-orange-50 transition cursor-pointer" href="/sva-obavestenja?all=1" >Погледај сва обавештења</Link>
                </div>
            </div>
        ...
        <div data-aos="fade-up" class="smerovi mx-auto max-w-screen-xl">
            <div  class="header-bigger-block text-gray-950 text-center my-10">
                <h2 class="!text-xl sm:!text-3xl font-medium"><strong class="font-bold">Основне</strong> академске студије </h2>
        ...
        >
            ...
            <Link
                class="relative text-gray-50 font-bold !text-xl sm:!text-2xl uppercase hover:text-red-800 text-shadow-lg transition"
                href="/prijava"
            >
        ...
        <div data-aos="fade-up" class="smerovi mx-auto max-w-screen-xl">
            <div  class="header-bigger-block text-gray-950 text-center my-10">
                <h2 class="!text-xl sm:!text-3xl font-medium"><strong class="font-bold">Мастер</strong> академске студије </h2>
                <span class="underline mx-auto w-1/9 bg-red-800 h-1 block rounded-sm"></span>
            </div>
